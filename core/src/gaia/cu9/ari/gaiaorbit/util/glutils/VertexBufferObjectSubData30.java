 ...
 * @author mzechner
 */
public class VertexBufferObjectSubData30 implements VertexData30 {
     ...
     */
    public VertexBufferObjectSubData30(boolean isStatic, int numVertices, VertexAttribute... attributes) {
    ...
    private int createBufferObject() {
        int result = Gdx.gl30.glGenBuffer();
        Gdx.gl30.glBindBuffer(GL30.GL_ARRAY_BUFFER, result);
        Gdx.gl30.glBufferData(GL30.GL_ARRAY_BUFFER, byteBuffer.capacity(), null, usage);
    ...
    private void bufferChanged() {
        if (isBound) {
            Gdx.gl30.glBufferSubData(GL30.GL_ARRAY_BUFFER, 0, byteBuffer.limit(), byteBuffer);
            isDirty = false;
        }
    }
