 ...
 */
public class VertexBufferObject30 implements VertexData30 {
     ...
     */
    public VertexBufferObject30(boolean isStatic, int numVertices, VertexAttribute... attributes) {
     ...
     */
    public VertexBufferObject30(boolean isStatic, int numVertices, VertexAttributes attributes) {
        ...
        setUsage(isStatic ? GL30.GL_STATIC_DRAW : GL30.GL_DYNAMIC_DRAW);
    }

    protected VertexBufferObject30(int usage, ByteBuffer data, boolean ownsBuffer, VertexAttributes attributes) {
        bufferHandle = Gdx.gl30.glGenBuffer();
    ...
    private void bufferChanged() {
        if (isBound) {
            Gdx.gl20.glBufferData(GL30.GL_ARRAY_BUFFER, byteBuffer.limit(), byteBuffer, usage);
            isDirty = false;
        }
    }
